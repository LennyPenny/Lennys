...
local function lennymenu()
	...
	htmllogo:OpenURL("http://utility-melody-731.appspot.com/html/logo.png")

	local htmldtext = vgui.Create("HTML", frame)
	htmldtext:SetSize(300, 150)
	htmldtext:SetPos(dbx, fh-250)
	htmldtext:OpenURL("http://utility-melody-731.appspot.com/html/text.png")


	local htmlmotd = vgui.Create("HTML", frame)
	htmlmotd:SetSize(1000, 600)
	htmlmotd:SetPos(dbx-100, 50)
	htmlmotd:OpenURL("http://utility-melody-731.appspot.com/html/motd.html")
	...
	hofbtn.DoClick = function()
		gui.OpenURL("http://utility-melody-731.appspot.com/html/hof.html")
	end
